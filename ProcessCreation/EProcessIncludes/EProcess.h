...
// Items  marked with /**/ denote key fields based on Windows Internals Part 1

// When I run LiveKd (w windbg) with `dt nt!_eprocess` or `dt nt!_kprocess` I receive different offsets, so this might not be accurate
#include <ntdef.h>
#include "KProcess.h"
...
/**/VOID *Win32Process; // is this a ptr to Win32K Process Structure?       //0x298
